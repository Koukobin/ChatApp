...
SOURCE_FOLDER="$(git rev-parse --show-toplevel)/ChatAppServer"
TARGET_JAR="$SOURCE_FOLDER/target/ChatAppServer.jar"
LIB_FOLDER="$SOURCE_FOLDER/target/lib"
DOC_FILES=("README.md" "LICENSE" "NOTICE")

INSTALL_FOLDER="ChatApp-Server-installer/srv/ChatApp-Server"
...
# Create DEB package
sudo dpkg-deb --build ChatApp-Server-installer || { echo "Failed to build DEB package"; exit 1; }
