...
public final class StartingScreenInfo {
	...
	public static final String CSS_LOCATION = StartingScreenInfo.class.getResource("/github/chatapp/client/main/resources/css/starting-screen.css").toExternalForm();
