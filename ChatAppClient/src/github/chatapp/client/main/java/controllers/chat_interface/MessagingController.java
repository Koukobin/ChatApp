...
import github.chatapp.client.main.java.util.ContextMenusUtil;
import github.chatapp.client.main.java.util.NotificationsUtil;
...
public class MessagingController extends GeneralController {
	...
	public void notifyUser(Message message, int chatSessionIndex, int activeChatSessionIndex) {
		 ...
		 */
		if (getParentRoot().isFocused() && chatSessionIndex == RootReferences.getChatsController().getActiveChatSessionIndex()) {
			return;
		}
		...
		NotificationsUtil.createNotification(new String(messageContent));
	}
	...
	public void deleteMessage(int messageIndex) {
		messagingBox.getChildren().remove(messageIndex);
	}
