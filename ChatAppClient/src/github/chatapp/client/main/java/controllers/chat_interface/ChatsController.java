...
public class ChatsController extends GeneralController {
	...
	public void addChatSessions(List<ChatSession> chatSessions) {
		for (ChatSession chatSession : chatSessions) {
			addChatSession(chatSession);
		}
	}
	
	public void addChatSession(ChatSession chatRequest) {
		chatSessionsListView.getItems().add(chatRequest);
	}
